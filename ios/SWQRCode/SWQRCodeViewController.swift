...
typealias QRCodeSuccessCallback = (_ value : String) -> Void

class SWQRCodeViewController: UIViewController {
    
    public var callBack: QRCodeSuccessCallback?
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem.init(title: "返回", style: .plain, target: self, action: #selector(finish))
